                            ...
                            <div class="post-inner">
                                <div class="post">
                                    <figure class="post-thumb">
                                        ...
                                        <a href="blog-details.php"><i class="fas fa-link"></i></a>
                                    </figure>
                            ...
                            <div class="widget-content">
                                <ul class="info-list clearfix">
                                    <li>
                                        ...
                                        IT Park, Plot 21, SIIDCUL, Sahastradhara Rd, Dehradun, Uttarakhand 248001
                                    </li>
                                    <li>
                                        <i class="fas fa-microphone"></i>
                                        <a href="tel:23055873407">+91 9971818206</a>
                                    </li>
                                    <li>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="footer-inner clearfix">
                <div class="copyright pull-left"><p><a href="index.php">OLX</a> &copy; 2020 All Right Reserved</p></div>

...
<!-- Mirrored from azim.commonsupport.com/Clasifico/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jul 2024 12:25:47 GMT -->
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

<title>OLX - Website Home Page</title>
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    <h4>Contact Info</h4>
                    <ul>
                        <li>Plot No. 21 , IT - Park Sahastradhara Road</li>
                        <li><a href="tel:+8801682648101">+91 9971818206</a></li>
                        <li><a href="mailto:info@example.com">amanbahukhandi07@gmail.com</a></li>
                    </ul>
                </div>
        ...
        <!-- banner-section -->
        <section class="banner-section centred" style="background-image: url(assets/images/banner/banner-1.jpg);">
                ...
                <div class="row clearfix">
                    <div class="col-lg-10 col-md-12 col-sm-12 offset-lg-1 content-column">
                        <div class="content-box">
                            ...
                            <p>Experience effortless transactions and find exactly what you're looking for in seconds..</p>
        ...
        <div class="sec-title">
            ...
            <p>Discover a world of possibilities—find what you need across diverse categories, <br />effortlessly and quickly.</p>
        </div>
        <div class="inner-content clearfix">
            <div id="category-container-index" class="category-grid"></div>
                    </div>
        <div class="more-btn"><a href="category.php" class="theme-btn-one">All Categories</a></div>
    </div>
        </section>
        ...
        <section class="feature-style-two">
            <div class="auto-container">
                <div class="sec-title centred">
                    <span>Features</span>
                    <h2>Featured Ads</h2>
                    <p>Check out our top picks and exclusive offers—find the best deals and <br />standout listings in one place.</p>
                </div>
                <div class="tabs-box">

                    <div class="tabs-content">
                        <div class="tab active-tab" id="tab-1">
                            <div class="row clearfix" id="featured-ads-container">
            ...
            <div class="auto-container">
                <div class="inner-content border-bottom">
                    <div class="sec-title centred">
                        ...
                        <p>Explore the hottest spots and trending locations—discover 
                        ...
                        <div class="content_block_1">
                            <div class="content-box">
                                ...
                                <div class="download-btn">
                                    <a href="index.php" class="app-store">
                                        <i class="icon-23"></i>
                                        <span>Download on</span>
                                        <h4>App Store</h4>
                                    </a>
                                    <a href="index.php" class="play-store">
                                        <i class="icon-24"></i>
                                        <span>Get It On</span>
                                        <h4>Google Play</h4>
                                    </a>
        ...
        <section class="news-section sec-pad">
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <h2>Stay Update with OLX</h2>
                </div>
                <div class="row clearfix" id="news-container">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-column">
                        <form action="https://azim.commonsupport.com/Clasifico/contact.html" method="post" class="subscribe-form">
                            <div class="form-group">
                                <input type="email" name="email" placeholder="Input your email address" required="" autocomplete="off">
...
<!-- Mirrored from azim.commonsupport.com/Clasifico/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jul 2024 12:26:06 GMT -->
</html>
